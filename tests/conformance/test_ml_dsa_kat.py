"""ML-DSA KAT scaffolding.

This test module intentionally skips when official vector files are absent.
Once vectors are added under `tests/conformance/vectors/ml_dsa/`, the loader
...
from tests.conformance.ml_dsa import load_ml_dsa_rsp, ml_dsa_records_by_section
